// --------------------------------------------------------------------------------------------------------------------
// <copyright file="XmlRepeater.cs" company="Sitecore Corporation">
...
namespace Sitecore.PrintStudio.JetstreamDemo.Rendering.Common
{
  using System;
  using System.Linq;
  ...
  public class XmlRepeater : InDesignItemRendererBase
  {
    ...
    protected override void BeginRender(PublishingEngine.PrintContext printContext)
    {
    ...
    protected override void RenderContent(PublishingEngine.PrintContext printContext, System.Xml.Linq.XElement output)
    {
